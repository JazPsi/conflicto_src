...
BLOG_AUTHOR = "Jazmín Vivas Cruz"  # (translatable)
BLOG_TITLE = "Conflicto Psíquico"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://conflictopsiquico.com.ar/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ejemplo.com/"
BLOG_EMAIL = "lic.vivascruz@gmail.com"
BLOG_DESCRIPTION = "Prevención, promoción y divulgación de Salud Mental. Psicoanálisis, Psicología comunitaria y Género. Atención psicológica."  # (translatable)
...
DATE_FORMAT = 'dd-MM-yyyy'#'yyyy-MM-dd HH:mm'
...
INDEX_READ_MORE_LINK = '<p class="more"><a href="{link}"><button class="button btn-leer">{read_more}…</a></button></p>'
...
# (translatable)
CONTENT_FOOTER = 'Creado por <a href="mailto:{email}">{author}</a> &copy; {date} - Con la tecnología de <a href="https://getnikola.com" rel="nofollow">Nikola</a> - {license}'
